...
<fieldset>
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td>
                <?=$row['likes']?>個人說
                <img src="./icon/02B03.jpg" alt="" style="width:25px;">
                <?php
                    if(isset($_SESSION['user']))
                    {
                        $count = $Log->count(['news'=>$row['id'], 'user'=>$_SESSION['user']]);
                        if($count == 0)
                        {
                            echo "<a href='#' data-id='{$row['id']}'  class='like'>讚</a>";
                        }else
                        {
                            echo "<a href='#' data-id='{$row['id']}'  class='like'>收回讚</a>";
                        }
                    }
                ?>
            </td>
